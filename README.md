...
git clone https://github.com/sahalpk007/InertiaPhysicsLab.git

# Navigate to project directory
cd InertiaPhysicsLab
...
```bash
# Fork the repository
git fork https://github.com/sahalpk007/InertiaPhysicsLab.git
...
- **GitHub Repository**: [Source Code](https://github.com/sahalpk007/InertiaPhysicsLab)
- **Issue Tracker**: [Report Bugs](https://github.com/sahalpk007/InertiaPhysicsLab/issues)
- **Discussions**: [Community Forum](https://github.com/sahalpk007/InertiaPhysicsLab/discussions)
